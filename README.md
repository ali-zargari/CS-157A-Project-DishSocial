...
## IMPORTANT: Both of the next commands need to run concurrently in 2 different command prompts or terminals.
## After runing Step 4, DO NOT close the command line or terminal Let it keep running.
...
-
![img_3.png](readme_img/img_3.png)npm run start:webpack
...
1. ### To connect to our online database and insert.
2. ### To recreate our database locally and insert.

####
##
### Here are steps for both the above scnarions:

### 1. Connecting to our online database using your own IDE:
...
### 2. Recreating the database Locally:
